                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-warning" style="width:102%;"   href="<?php echo "edit_images.php?product_id=". $product['product_id']."&product_name=".$product['product_name'];?>">Edit Images</a></td>
